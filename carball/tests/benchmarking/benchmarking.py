...
def test_short_sample(benchmark):
    ...
    benchmark.pedantic(analyze_replay_file,
                       kwargs={"replay_path":replay_path}, rounds=5, iterations=1)
...
#
#     benchmark.pedantic(analyze_replay_file,
#                        kwargs={"replay_path":replay_path}, rounds=3, iterations=1)
#
#
...
#
#     benchmark.pedantic(analyze_replay_file,
#                        kwargs={"replay_path":replay_path, "calculate_intensive_events":True}, rounds=3, iterations=1)
